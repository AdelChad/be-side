    ...
    <div class="form-container">
      ...
      <form class="w-100">
        <div class="mb-3">
          ...
          <input type="email" id="email" class="form-control" placeholder="Entrez votre e-mail" :value="email"
            @input="(event) => (email = (event.target as HTMLInputElement).value)" required />
        </div>

        <div class="mb-3">
          <label for="password" class="form-label fw-medium">Mot de passe</label>
          <input type="password" id="password" :value="password"
            @input="(event) => (password = (event.target as HTMLInputElement).value)" required class="form-control"
        ...
        <div class="text-center mt-3">
          ...
          <router-link to="/auth" class="text-primary fw-bold">S'inscrire !</router-link>
        </div>
      </form>
    </div>
  </div>
