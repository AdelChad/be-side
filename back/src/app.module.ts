...
@Module({
  imports: [
    PlanningModule, DatabaseModule, ActivitiesModule, AuthModule, UserModule, CategModule, CategRestauModule, GoogleApiModule, ActivityDayModule, RestaurantsModule, GroupeModule, MessageModule, ChatModule, ClashModule, ConfigModule.forRoot({ isGlobal: true })],
