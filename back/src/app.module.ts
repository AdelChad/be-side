...
@Module({
  imports: [
    PlanningModule, DatabaseModule, ActivitiesModule, AuthModule, UserModule, CategModule, CategRestauModule, GoogleApiModule, ActivityDayModule, RestaurantsModule, GroupeModule, MessageModule, ChatModule, ConfigModule.forRoot({ isGlobal: true })],
