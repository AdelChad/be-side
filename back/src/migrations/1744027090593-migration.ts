...
export class Migration1744027090593 implements MigrationInterface {
    name = 'Migration1744027090593'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`profilePicture\``);
        await queryRunner.query(`ALTER TABLE \`restaurant\` ADD \`photo\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`activities\` ADD \`photo\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`restaurant\` DROP COLUMN \`photo\``);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`profilePicture\` varchar(255) NULL DEFAULT 'NULL'`);
    }
