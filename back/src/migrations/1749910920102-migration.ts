...
export class Migration1749910920102 implements MigrationInterface {
    name = 'Migration1749910920102'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`clash\` ADD \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
        ...
        await queryRunner.query(`ALTER TABLE \`vote\` CHANGE \`clashId\` \`clashId\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`clash\` CHANGE \`activityOptionAId\` \`activityOptionAId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`clash\` CHANGE \`activityOptionBId\` \`activityOptionBId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`clash\` CHANGE \`restaurantOptionAId\` \`restaurantOptionAId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`clash\` CHANGE \`restaurantOptionBId\` \`restaurantOptionBId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`dateJoined\` \`dateJoined\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP()`);
        await queryRunner.query(`ALTER TABLE \`clash\` CHANGE \`restaurantOptionBId\` \`restaurantOptionBId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`clash\` CHANGE \`restaurantOptionAId\` \`restaurantOptionAId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`clash\` CHANGE \`activityOptionBId\` \`activityOptionBId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`clash\` CHANGE \`activityOptionAId\` \`activityOptionAId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`clash\` ADD CONSTRAINT \`FK_b4ac5176a884ef3201dba5566c9\` FOREIGN KEY (\`restaurantOptionBId\`) REFERENCES \`restaurant\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`clash\` ADD CONSTRAINT \`FK_1b5cd59d35f234d764cac4c7e4a\` FOREIGN KEY (\`restaurantOptionAId\`) REFERENCES \`restaurant\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`clash\` ADD CONSTRAINT \`FK_12e4682bac3bbad469f183d171c\` FOREIGN KEY (\`activityOptionBId\`) REFERENCES \`activities\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`clash\` ADD CONSTRAINT \`FK_8d6587ec4aeee50be2dedd01a33\` FOREIGN KEY (\`activityOptionAId\`) REFERENCES \`activities\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`vote\` CHANGE \`userId\` \`userId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`vote\` CHANGE \`clashId\` \`clashId\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`vote\` ADD CONSTRAINT \`FK_f5de237a438d298031d11a57c3b\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`vote\` ADD CONSTRAINT \`FK_8cf3d3f709804878bf226763dba\` FOREIGN KEY (\`clashId\`) REFERENCES \`clash\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`clash\` DROP COLUMN \`createdAt\``);
    }
